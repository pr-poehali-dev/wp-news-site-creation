...
export const ARTICLES: Article[] = [
  ...
  { id: 9, slug: 'federalnyy-byudzhet-2027', title: 'Федеральный бюджет на 2027 год: что изменится для регионов', excerpt: 'Правительство представило проект расходов — эксперты объясняют, что это значит для территорий за пределами Москвы.', category: 'Федеральные новости', tags: ['аналитика', 'данные'], date: '18 июня 2026', readMin: 7, author: 'Игорь Снегов', image: 'https://cdn.poehali.dev/projects/c9190c0b-89c7-4186-a95c-d2ead77fea4b/files/56357ccf-37fc-4b1c-b1fb-537916f46556.jpg', body: LOREM },
  { id: 10, slug: 'infrastruktura-trassy', title: 'Тысяча километров новых трасс: как идёт стройка федеральных дорог', excerpt: 'Репортаж с объектов крупнейшей дорожной программы последних лет — от Урала до юга страны.', category: 'Федеральные новости', tags: ['репортаж', 'хроника'], date: '17 июня 2026', readMin: 9, author: 'Пётр Зорин', image: 'https://cdn.poehali.dev/projects/c9190c0b-89c7-4186-a95c-d2ead77fea4b/files/f1c8a1d2-3e38-41d5-91c4-4b0685733565.jpg', body: LOREM },
  { id: 11, slug: 'socialnaya-politika-2026', title: 'Социальная политика меняет курс: что получат семьи с детьми', excerpt: 'Новый пакет мер поддержки вступает в силу с июля — разбираем, кто и сколько получит.', category: 'Федеральные новости', tags: ['аналитика', 'данные'], date: '16 июня 2026', readMin: 6, author: 'Анна Веденеева', image: 'https://cdn.poehali.dev/projects/c9190c0b-89c7-4186-a95c-d2ead77fea4b/files/a590c5ab-2605-437d-a553-f80df2f45a76.jpg', body: LOREM },
];
